...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Nov-2019 às 15:15
...
--
-- Estrutura da tabela `perfil do aluno`
--

CREATE TABLE `perfil do aluno` (
  `id` int(50) NOT NULL,
  `nome` varchar(60) NOT NULL,
  ...
  `email` varchar(60) NOT NULL,
  `codigo postal` varchar(60) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `perfil do funcionário`
--

CREATE TABLE `perfil do funcionário` (
  `id` int(50) NOT NULL,
  `nome` varchar(60) NOT NULL,
  `email` varchar(60) NOT NULL,
  `cidade` varchar(60) NOT NULL,
  ...
  `endereço` varchar(60) NOT NULL,
  `codigo postal` int(60) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `perfil do professor`
--

CREATE TABLE `perfil do professor` (
  `id` int(50) NOT NULL,
  `nome` varchar(60) NOT NULL,
  `email` varchar(60) NOT NULL,
  `codigo postal` varchar(60) NOT NULL,
...
--
ALTER TABLE `alunos`
  MODIFY `id` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1231231232;
--
...
--
ALTER TABLE `professor`
  MODIFY `id` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12347;COMMIT;
